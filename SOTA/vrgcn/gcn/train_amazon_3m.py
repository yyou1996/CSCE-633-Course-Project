...
flags.DEFINE_integer('epochs', 20, 'Min number of epochs to train.')
...
# Load data
num_data, train_adj, full_adj, features, train_features, test_features, labels, train_d, val_d, test_d = utils.amazon_3m_loader()
