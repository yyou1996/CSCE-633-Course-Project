...
def amazon_670k_loader():
    ...
    return Adj_hat.shape[0], Adj_hat, Adj_hat, sps.csr_matrix(feat), sps.csr_matrix(feat), sps.csr_matrix(feat), y, np.array(dataset_split['train'], dtype=np.int32), np.array([0], dtype=np.int32), np.array(dataset_split['test'], dtype=np.int32)
