...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('dataset', 'amazon', 'Dataset string.')  # 'cora', 'citeseer', 'pubmed'
...
def main(rank1):
    ...
    adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask = utils.amazon_670k_loader()
